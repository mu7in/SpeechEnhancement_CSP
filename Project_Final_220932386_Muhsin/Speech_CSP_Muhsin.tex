...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{block_diagram.png}}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\linewidth]{1_original_signal.png}
\caption{Original speech signal}
\label{fig:original}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\linewidth]{2_noisy_signal.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{3_fir_output.png}
\caption{FIR filter output}
\label{fig:fir}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{4_iir_output.png}
\caption{IIR filter output}
\label{fig:iir}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{6_fft_noisy.png}
\caption{Frequency spectrum of noisy speech signal}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{7_fft_fir.png}
\caption{Frequency spectrum after FIR filtering}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{8_fft_iir.png}
\caption{Frequency spectrum after IIR filtering}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{9_fir_response.png}
\caption{Frequency response of FIR filter}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{10_iir_response.png}
\caption{Frequency response of IIR filter}
\end{figure}
